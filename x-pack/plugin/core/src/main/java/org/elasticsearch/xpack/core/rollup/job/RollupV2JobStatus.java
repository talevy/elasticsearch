 ...
 */
public class RollupV2JobStatus implements Task.Status, PersistentTaskState {
    ...
    public static final ConstructingObjectParser<RollupV2JobStatus, Void> PARSER =
            new ConstructingObjectParser<>(NAME,
                    args -> new RollupV2JobStatus((IndexerState) args[0], (HashMap<String, Object>) args[1]));
    ...
    public RollupV2JobStatus(IndexerState state, @Nullable Map<String, Object> position) {
        this.state = state;
        this.currentPosition = position == null ? null : new TreeMap<>(position);
    }

    public RollupV2JobStatus(StreamInput in) throws IOException {
    ...
    public static RollupV2JobStatus fromXContent(XContentParser parser) {
        try {
    ...
    public boolean equals(Object other) {
        ...
        RollupV2JobStatus that = (RollupV2JobStatus) other;
