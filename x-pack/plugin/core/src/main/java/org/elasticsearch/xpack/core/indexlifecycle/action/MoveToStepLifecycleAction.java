...
public class MoveToStepLifecycleAction extends Action<MoveToStepLifecycleAction.Request, MoveToStepLifecycleAction.Response, MoveToStepLifecycleAction.RequestBuilder> {
    public static final MoveToStepLifecycleAction INSTANCE = new MoveToStepLifecycleAction();
    public static final String NAME = "cluster:admin/xpack/index_lifecycle/_move/post";

    protected MoveToStepLifecycleAction() {
        super(NAME);
    }
    ...
    public static class Request extends AcknowledgedRequest<Request> {
        ...
        private static final ConstructingObjectParser<Request, String> PARSER =
            new ConstructingObjectParser<>("move_to_step_request",
                a -> {
                String index = (String) a[0];
                StepKey currentStepKey = (StepKey) a[1];
                StepKey nextStepKey = (StepKey) a[2];
