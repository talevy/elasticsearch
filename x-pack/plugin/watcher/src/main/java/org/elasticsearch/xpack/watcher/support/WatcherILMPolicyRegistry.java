...
public class WatcherILMPolicyRegistry implements ClusterStateListener {
    ...
    private static final Logger logger = LogManager.getLogger(WatcherILMPolicyRegistry.class);
    ...
    public WatcherILMPolicyRegistry(ClusterService clusterService, ThreadPool threadPool, Client client) {
        this.client = client;
