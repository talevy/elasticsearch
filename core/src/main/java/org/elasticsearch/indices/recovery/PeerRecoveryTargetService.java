...
public class PeerRecoveryTargetService extends AbstractComponent implements IndexEventListener {
    ...
    public PeerRecoveryTargetService(Settings settings, ThreadPool threadPool, TransportService transportService, RecoverySettings
        ...
        transportService.registerRequestHandler(Actions.CLEAN_FILES, ThreadPool.Names.GENERIC, RecoveryCleanFilesRequest::new,
        ...
        transportService.registerRequestHandler(Actions.TRANSLOG_OPS,ThreadPool.Names.GENERIC,
        ...
        transportService.registerRequestHandler(Actions.WAIT_CLUSTERSTATE, ThreadPool.Names.GENERIC,
            RecoveryWaitForClusterStateRequest::new, new WaitForClusterStateRequestHandler());
