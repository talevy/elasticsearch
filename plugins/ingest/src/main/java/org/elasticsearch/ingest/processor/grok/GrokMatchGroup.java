...
import java.lang.Float;import java.lang.Integer;import java.lang.Object;import java.lang.String;public class GrokMatchGroup {
    ...
    public GrokMatchGroup(String groupName, String groupValue) {
        ...
        patternName = parts[0];
        if (parts.length >= 2) { fieldName = parts[1]; }
