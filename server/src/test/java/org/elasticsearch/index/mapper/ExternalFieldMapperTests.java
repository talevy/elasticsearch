...
public class ExternalFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testExternalValues() throws Exception {
        ...
        MapperRegistry mapperRegistry = new MapperRegistry(
                ...
                singletonMap(ExternalMetadataMapper.CONTENT_TYPE, new ExternalMetadataMapper.TypeParser()), MapperPlugin.NOOP_FIELD_FILTER, Collections.emptyMap());
    ...
    public void testExternalValuesWithMultifield() throws Exception {
        ...
        MapperRegistry mapperRegistry = new MapperRegistry(mapperParsers, Collections.emptyMap(), MapperPlugin.NOOP_FIELD_FILTER, Collections.emptyMap());
