...
public class LinearRingEdgeTreeTests extends ESTestCase {
    ...
    public void testRectangleShape() throws IOException {
        for (int i = 0; i < 1000; i++) {
            ...
            output.close();
            EdgeTreeReader reader = new EdgeTreeReader.LinearRingEdgeTreeReader(new ByteBufferStreamInput(ByteBuffer.wrap(output.bytes().toBytesRef().bytes)));
