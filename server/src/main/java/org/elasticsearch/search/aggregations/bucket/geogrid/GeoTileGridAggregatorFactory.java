...
public class GeoTileGridAggregatorFactory extends ValuesSourceAggregatorFactory<ValuesSource, GeoTileGridAggregatorFactory> {

    private final int precision;
    private final int requiredSize;
    private final int shardSize;

    GeoTileGridAggregatorFactory(String name, ValuesSourceConfig<ValuesSource> config, int precision, int requiredSize,
