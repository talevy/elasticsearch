...
public enum ValueType implements Writeable {
    ...
    GEOPOINT((byte) 8, "geo_point", "geo_point", ValuesSourceType.GEOPOINT, IndexGeoFieldData.IndexGeoPointFieldData.class, DocValueFormat.GEOHASH),
    BOOLEAN((byte) 9, "boolean", "boolean", ValuesSourceType.NUMERIC, IndexNumericFieldData.class, DocValueFormat.BOOLEAN),
    GEOSHAPE((byte) 10, "geo_shape", "geo_shape", ValuesSourceType.GEOSHAPE, IndexGeoFieldData.IndexGeoShapeFieldData.class, DocValueFormat.RAW),
